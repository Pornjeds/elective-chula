...
( NAME = N'eaw01', FILENAME = N'C:\MBAEnrollmentDB\eaw01.mdf' , SIZE = 10240KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'eaw01_log', FILENAME = N'C:\MBAEnrollmentDB\eaw01_log.ldf' , SIZE = 10240KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
GO
/****** Object:  Table [dbo].[ADMIN_ACTIVATESCHEDULE]    Script Date: 01/12/2015 23:44:56 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[ADMIN_ACTIVATESCHEDULE](
	[id] [int] NOT NULL IDENTITY(1,1),
	...
	[logdate] [datetime] NOT NULL,
 CONSTRAINT [PK_ADMIN_ACTIVATESCHEDULE] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
